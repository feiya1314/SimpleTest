...
- **提出者**：HashiCorp 联合创始人 **Mitchell Hashimoto**，2026 年 2 月在其博客《My AI Adoption Journey》中首次正式提出
- **推广者**：OpenAI 官方博客《Harness engineering: leveraging Codex in an agent-first world》将其推向主流——文章记录了一个 3 人团队几乎不手写代码，仅靠引导 Agent，用 5 个月构建百万行代码级产品、合并约 1,500 个 PR 的实验
- **本质定位**：并非全新发明，而是对一系列现有工程实践的系统性总结与命名
...
构建 Harness 时必须直面三大核心约束（参考信息以图示呈现、文字未展开，此处为作者归纳：LLM 输出的**非确定性**、上下文窗口的**有限性**、真实执行环境的**不可控性**），并以六大设计原则作为应对之道：
...
| 记忆与状态管理 | 模型跨轮该记住什么？上一轮发生过的事情，怎么流动到下一轮 | **状态外化到文件系统**（如 claude-progress.txt、init.sh、git history），下一轮干净窗口读文件即可恢复进度；任务状态/会话中间结果/长期记忆分层。<span style="color: rgb(74, 74, 74); font-family: &quot;PingFang SC NEW&quot;, system-ui, -apple-system, BlinkMacSystemFont, &quot;Helvetica Neue&quot;, &quot;Hiragino Sans GB&quot;, &quot;Microsoft YaHei UI&quot;, &quot;Microsoft YaHei&quot;, Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: left; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">没有状态管理的 Agent，每一轮调用之间都是失忆的。</span> |

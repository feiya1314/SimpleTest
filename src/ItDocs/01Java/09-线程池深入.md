...
![无界队列示意图](../assets/01Java/8ff2ccd3b892451ea6e7a8bbcca91a48.png)
...
![keepAliveTime示意图](../assets/01Java/b25e3b52724e438d9ef2bdc0dd5694a4.png)
...
| 对比维度 | execute() | submit() |
|---------|----------|---------|
| 返回值 | void，无返回结果 | 返回Future<T>，可获取执行结果 |

...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LangChain大约 9 分钟约 2781 字

---

# [3. LangChain 的底层架构与实现原理是什么？](#_3-langchain-的底层架构与实现原理是什么)
...
**来源**: https://xiaolinnote.com/ai/langchain/langchain_architecture.html

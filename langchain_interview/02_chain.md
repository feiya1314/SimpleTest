...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LangChain大约 16 分钟约 4763 字

---

# [2. 请你谈谈对 LangChain 中核心概念「Chain」的理解，以及它的核心作用与设计理念。](#_2-请你谈谈对-langchain-中核心概念「chain」的理解-以及它的核心作用与设计理念。)
...
**来源**: https://xiaolinnote.com/ai/langchain/chain.html

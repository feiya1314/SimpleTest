...
原创[公众号@小林面试笔记](https://xiaolinnote.com)LangChain大约 10 分钟约 3049 字

---

# [4. 使用 LangChain 构建 Agent 的核心步骤是什么？](#_4-使用-langchain-构建-agent-的核心步骤是什么)
...
**来源**: https://xiaolinnote.com/ai/langchain/build_agent.html
